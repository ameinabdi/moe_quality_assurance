...
import { useAppDispatch } from 'src/modules/hook';import schoolSelectors from 'src/modules/school/schoolSelectors';
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=school">
