...
import SchoolFormModal from 'src/view/school/form/SchoolFormModal';
...
const SchoolAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return SchoolService.listAutocomplete(value, limit);
  };
...
export default SchoolAutocompleteFormItem;
