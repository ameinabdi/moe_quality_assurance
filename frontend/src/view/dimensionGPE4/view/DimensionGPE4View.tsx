  ...
  return (
    <ViewWrapper>
      {Boolean(record.indicator41) && (
        ...
        >
          {i18n(
            `entities.dimensionGPE4.enumerators.indicator41.${record.indicator41}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator42) && (
        ...
        >
          {i18n(
            `entities.dimensionGPE4.enumerators.indicator42.${record.indicator42}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator43) && (
        ...
        >
          {i18n(
            `entities.dimensionGPE4.enumerators.indicator43.${record.indicator43}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator44) && (
        ...
        >
          {i18n(
            `entities.dimensionGPE4.enumerators.indicator44.${record.indicator44}`,
          )}
        </Form.Item>
      )}
...
export default DimensionGPE4View;
