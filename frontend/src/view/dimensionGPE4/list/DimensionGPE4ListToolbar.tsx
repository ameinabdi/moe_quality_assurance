...
const DimensionGPE4Toolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    dimensionGPE4Selectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    dimensionGPE4Selectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToImport && (
        <Link to="/dimension-g-p-e4/importer">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=dimensionGPE4">
...
export default DimensionGPE4Toolbar;
