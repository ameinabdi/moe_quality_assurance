...
const QuestionSectionToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    questionSectionSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    questionSectionSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToImport && (
        <Link to="/question-section/importer">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=questionSection">
...
export default QuestionSectionToolbar;
