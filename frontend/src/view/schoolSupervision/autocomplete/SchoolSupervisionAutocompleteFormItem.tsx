...
import SchoolSupervisionFormModal from 'src/view/schoolSupervision/form/SchoolSupervisionFormModal';
...
const SchoolSupervisionAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return SchoolSupervisionService.listAutocomplete(value, limit);
  };
...
export default SchoolSupervisionAutocompleteFormItem;
