...
const SchoolSupervisionForm = (props) => {
  const [initialValues] = useState(() => {
    ...
    return {
      ...
      indicator31: record?.dimension2?.indicator31,
      indicator32: record?.dimension2?.indicator32,
      indicator33: record?.dimension2?.indicator33,
      indicator34: record?.dimension2?.indicator34,
      indicator35: record?.dimension2?.indicator35,
      indicator36: record?.dimension2?.indicator36,
      indicator37: record?.dimension2?.indicator37,
      indicator38: record?.dimension2?.indicator38,
      indicator39: record?.dimension2?.indicator39,
      indicator310: record?.dimension2?.indicator310,
      indicator311: record?.dimension2?.indicator311,
      indicator312: record?.dimension2?.indicator312,
      indicator313: record?.dimension2?.indicator313,
      indicator314: record?.dimension2?.indicator314,
      indicator315: record?.dimension2?.indicator315,
