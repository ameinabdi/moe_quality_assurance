...
import DistrictFormModal from 'src/view/district/form/DistrictFormModal';
...
const DistrictAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return DistrictService.listAutocomplete(value, limit);
  };
...
export default DistrictAutocompleteFormItem;
