...
const DistrictToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    districtSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    districtSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=district">
