...
const DimensionGPE1ListTable = (props) => {
  ...
  const columns = [
      {
        title: i18n('entities.dimensionGPE1.fields.indicator11'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.indicator12'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.indicator13'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.indicator14'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.indicator15'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.indicator16'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.indicator17'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.indicator18'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.indicator19'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.indicator110'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.indicator111'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.indicator112'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.indicator113'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.indicator114'),
        sorter: true,
      ...
      {
        title: i18n('entities.dimensionGPE1.fields.school'),
        sorter: false,
        dataIndex: 'school',
      ...
      },
    {
      ...
      render: (_, record) => (
        <div className="table-actions">
          <Link to={`/dimension-g-p-e1/${record.id}`}>
            {i18n('common.view')}
          </Link>
          {hasPermissionToEdit && (
            <Link to={`/dimension-g-p-e1/${record.id}/edit`}>
              {i18n('common.edit')}
            </Link>
          )}
...
export default DimensionGPE1ListTable;
