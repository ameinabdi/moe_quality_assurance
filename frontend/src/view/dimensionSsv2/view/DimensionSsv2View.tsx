  ...
  return (
    <ViewWrapper>
      {Boolean(record.indicator31) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator31.${record.indicator31}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator32) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator32.${record.indicator32}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator33) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator33.${record.indicator33}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator34) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator34.${record.indicator34}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator35) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator35.${record.indicator35}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator36) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator36.${record.indicator36}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator37) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator37.${record.indicator37}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator38) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator38.${record.indicator38}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator39) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator39.${record.indicator39}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator310) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator310.${record.indicator310}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator311) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator311.${record.indicator311}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator312) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator312.${record.indicator312}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator313) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator313.${record.indicator313}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator314) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator314.${record.indicator314}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator315) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv2.enumerators.indicator315.${record.indicator315}`,
          )}
        </Form.Item>
      )}
...
export default DimensionSsv2View;
