...
const previewRenders = {
  indicator31: {
    ...
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator31',),
  },
  indicator32: {
    label: i18n('entities.dimensionSsv2.fields.indicator32'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator32',),
  },
  indicator33: {
    label: i18n('entities.dimensionSsv2.fields.indicator33'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator33',),
  },
  indicator34: {
    label: i18n('entities.dimensionSsv2.fields.indicator34'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator34',),
  },
  indicator35: {
    label: i18n('entities.dimensionSsv2.fields.indicator35'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator35',),
  },
  indicator36: {
    label: i18n('entities.dimensionSsv2.fields.indicator36'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator36',),
  },
  indicator37: {
    label: i18n('entities.dimensionSsv2.fields.indicator37'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator37',),
  },
  indicator38: {
    label: i18n('entities.dimensionSsv2.fields.indicator38'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator38',),
  },
  indicator39: {
    label: i18n('entities.dimensionSsv2.fields.indicator39'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator39',),
  },
  indicator310: {
    label: i18n('entities.dimensionSsv2.fields.indicator310'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator310',),
  },
  indicator311: {
    label: i18n('entities.dimensionSsv2.fields.indicator311'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator311',),
  },
  indicator312: {
    label: i18n('entities.dimensionSsv2.fields.indicator312'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator312',),
  },
  indicator313: {
    label: i18n('entities.dimensionSsv2.fields.indicator313'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator313',),
  },
  indicator314: {
    label: i18n('entities.dimensionSsv2.fields.indicator314'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator314',),
  },
  indicator315: {
    label: i18n('entities.dimensionSsv2.fields.indicator315'),
    render: filterRenders.enumerator('entities.dimensionSsv2.enumerators.indicator315',),
  },
  school: {
...
const DimensionSsv2ListFilter = (props) => {
              ...
              <Row gutter={24}>
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator31"
                    label={i18n('entities.dimensionSsv2.fields.indicator31')}
                    options={dimensionSsv2Enumerators.indicator31.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator32"
                    label={i18n('entities.dimensionSsv2.fields.indicator32')}
                    options={dimensionSsv2Enumerators.indicator32.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator33"
                    label={i18n('entities.dimensionSsv2.fields.indicator33')}
                    options={dimensionSsv2Enumerators.indicator33.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator34"
                    label={i18n('entities.dimensionSsv2.fields.indicator34')}
                    options={dimensionSsv2Enumerators.indicator34.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator35"
                    label={i18n('entities.dimensionSsv2.fields.indicator35')}
                    options={dimensionSsv2Enumerators.indicator35.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator36"
                    label={i18n('entities.dimensionSsv2.fields.indicator36')}
                    options={dimensionSsv2Enumerators.indicator36.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator37"
                    label={i18n('entities.dimensionSsv2.fields.indicator37')}
                    options={dimensionSsv2Enumerators.indicator37.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator38"
                    label={i18n('entities.dimensionSsv2.fields.indicator38')}
                    options={dimensionSsv2Enumerators.indicator38.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator39"
                    label={i18n('entities.dimensionSsv2.fields.indicator39')}
                    options={dimensionSsv2Enumerators.indicator39.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator310"
                    label={i18n('entities.dimensionSsv2.fields.indicator310')}
                    options={dimensionSsv2Enumerators.indicator310.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator311"
                    label={i18n('entities.dimensionSsv2.fields.indicator311')}
                    options={dimensionSsv2Enumerators.indicator311.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator312"
                    label={i18n('entities.dimensionSsv2.fields.indicator312')}
                    options={dimensionSsv2Enumerators.indicator312.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator313"
                    label={i18n('entities.dimensionSsv2.fields.indicator313')}
                    options={dimensionSsv2Enumerators.indicator313.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator314"
                    label={i18n('entities.dimensionSsv2.fields.indicator314')}
                    options={dimensionSsv2Enumerators.indicator314.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator315"
                    label={i18n('entities.dimensionSsv2.fields.indicator315')}
                    options={dimensionSsv2Enumerators.indicator315.map(
                      (value) => ({
                        value,
                        label: i18n(
...
export default DimensionSsv2ListFilter;