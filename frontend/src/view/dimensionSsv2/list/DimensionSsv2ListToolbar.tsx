...
const DimensionSsv2Toolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    dimensionSsv2Selectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    dimensionSsv2Selectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToImport && (
        <Link to="/dimension-ssv2/importer">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=dimensionSsv2">
...
export default DimensionSsv2Toolbar;
