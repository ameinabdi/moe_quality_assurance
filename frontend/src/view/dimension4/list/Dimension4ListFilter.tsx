...
const previewRenders = {
  indicator41: {
    ...
    render: filterRenders.enumerator('entities.dimension4.enumerators.indicator41',),
  },
  indicator42: {
    label: i18n('entities.dimension4.fields.indicator42'),
    render: filterRenders.enumerator('entities.dimension4.enumerators.indicator42',),
  },
  indicator43: {
    label: i18n('entities.dimension4.fields.indicator43'),
    render: filterRenders.enumerator('entities.dimension4.enumerators.indicator43',),
  },
  indicator44: {
    label: i18n('entities.dimension4.fields.indicator44'),
    render: filterRenders.enumerator('entities.dimension4.enumerators.indicator44',),
  },
  school: {
...
const Dimension4ListFilter = (props) => {
...
export default Dimension4ListFilter;