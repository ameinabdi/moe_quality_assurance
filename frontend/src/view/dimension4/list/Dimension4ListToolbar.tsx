...
import { useAppDispatch } from 'src/modules/hook';import dimension4Selectors from 'src/modules/dimension4/dimension4Selectors';
...
const Dimension4Toolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    dimension4Selectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    dimension4Selectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=dimension4">
...
export default Dimension4Toolbar;
