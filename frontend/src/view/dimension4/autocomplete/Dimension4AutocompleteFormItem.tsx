...
import Dimension4FormModal from 'src/view/dimension4/form/Dimension4FormModal';
...
const Dimension4AutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return Dimension4Service.listAutocomplete(value, limit);
  };
...
export default Dimension4AutocompleteFormItem;
