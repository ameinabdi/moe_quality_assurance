...
const schema = yup.object().shape({
  ...
  school: yupFilterSchemas.relationToOne(
    i18n('entities.dimension5.fields.school'),
  ),
});
...
const previewRenders = {
  indicator51: {
    ...
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator51',),
  },
  indicator52: {
    label: i18n('entities.dimension5.fields.indicator52'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator52',),
  },
  indicator53: {
    label: i18n('entities.dimension5.fields.indicator53'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator53',),
  },
  indicator54: {
    label: i18n('entities.dimension5.fields.indicator54'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator54',),
  },
  indicator55: {
    label: i18n('entities.dimension5.fields.indicator55'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator55',),
  },
  indicator56: {
    label: i18n('entities.dimension5.fields.indicator56'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator56',),
  },
  indicator57: {
    label: i18n('entities.dimension5.fields.indicator57'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator57',),
  },
  indicator58: {
    label: i18n('entities.dimension5.fields.indicator58'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator58',),
  },
  indicator59: {
    label: i18n('entities.dimension5.fields.indicator59'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator59',),
  },
  indicator510: {
    label: i18n('entities.dimension5.fields.indicator510'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator510',),
  },
  indicator511: {
    label: i18n('entities.dimension5.fields.indicator511'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator511',),
  },
  indicator512: {
    label: i18n('entities.dimension5.fields.indicator512'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator512',),
  },
  indicator513: {
    label: i18n('entities.dimension5.fields.indicator513'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator513',),
  },
  indicator514: {
    label: i18n('entities.dimension5.fields.indicator514'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator514',),
  },
  indicator515: {
    label: i18n('entities.dimension5.fields.indicator515'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator515',),
  },
  indicator516: {
    label: i18n('entities.dimension5.fields.indicator516'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator516',),
  },
  indicator517: {
    label: i18n('entities.dimension5.fields.indicator517'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator517',),
  },
  indicator518: {
    label: i18n('entities.dimension5.fields.indicator518'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator518',),
  },
  indicator519: {
    label: i18n('entities.dimension5.fields.indicator519'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator519',),
  },
  indicator520: {
    label: i18n('entities.dimension5.fields.indicator520'),
    render: filterRenders.enumerator('entities.dimension5.enumerators.indicator520',),
  },
  school: {
...
const Dimension5ListFilter = (props) => {
              ...
              <Row gutter={24}>
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator51"
                    label={i18n('entities.dimension5.fields.indicator51')}
                    options={dimension5Enumerators.indicator51.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator52"
                    label={i18n('entities.dimension5.fields.indicator52')}
                    options={dimension5Enumerators.indicator52.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator53"
                    label={i18n('entities.dimension5.fields.indicator53')}
                    options={dimension5Enumerators.indicator53.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator54"
                    label={i18n('entities.dimension5.fields.indicator54')}
                    options={dimension5Enumerators.indicator54.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator55"
                    label={i18n('entities.dimension5.fields.indicator55')}
                    options={dimension5Enumerators.indicator55.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator56"
                    label={i18n('entities.dimension5.fields.indicator56')}
                    options={dimension5Enumerators.indicator56.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator57"
                    label={i18n('entities.dimension5.fields.indicator57')}
                    options={dimension5Enumerators.indicator57.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator58"
                    label={i18n('entities.dimension5.fields.indicator58')}
                    options={dimension5Enumerators.indicator58.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator59"
                    label={i18n('entities.dimension5.fields.indicator59')}
                    options={dimension5Enumerators.indicator59.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator510"
                    label={i18n('entities.dimension5.fields.indicator510')}
                    options={dimension5Enumerators.indicator510.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator511"
                    label={i18n('entities.dimension5.fields.indicator511')}
                    options={dimension5Enumerators.indicator511.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator512"
                    label={i18n('entities.dimension5.fields.indicator512')}
                    options={dimension5Enumerators.indicator512.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator513"
                    label={i18n('entities.dimension5.fields.indicator513')}
                    options={dimension5Enumerators.indicator513.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator514"
                    label={i18n('entities.dimension5.fields.indicator514')}
                    options={dimension5Enumerators.indicator514.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator515"
                    label={i18n('entities.dimension5.fields.indicator515')}
                    options={dimension5Enumerators.indicator515.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator516"
                    label={i18n('entities.dimension5.fields.indicator516')}
                    options={dimension5Enumerators.indicator516.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator517"
                    label={i18n('entities.dimension5.fields.indicator517')}
                    options={dimension5Enumerators.indicator517.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator518"
                    label={i18n('entities.dimension5.fields.indicator518')}
                    options={dimension5Enumerators.indicator518.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator519"
                    label={i18n('entities.dimension5.fields.indicator519')}
                    options={dimension5Enumerators.indicator519.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator520"
                    label={i18n('entities.dimension5.fields.indicator520')}
                    options={dimension5Enumerators.indicator520.map(
                      (value) => ({
                        value,
                        label: i18n(
...
export default Dimension5ListFilter;