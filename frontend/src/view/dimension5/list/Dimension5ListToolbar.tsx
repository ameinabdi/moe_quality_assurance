...
import { useAppDispatch } from 'src/modules/hook';import dimension5Selectors from 'src/modules/dimension5/dimension5Selectors';
...
const Dimension5Toolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    dimension5Selectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    dimension5Selectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=dimension5">
...
export default Dimension5Toolbar;
