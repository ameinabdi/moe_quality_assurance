...
const GovernmentTeacherInformationToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    governmentTeacherInformationSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    governmentTeacherInformationSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      {hasPermissionToCreate && (
        <Link to="/government-teacher-information/new">
      ...
      {hasPermissionToImport && (
        <Link to="/government-teacher-information/importer">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=governmentTeacherInformation">
...
export default GovernmentTeacherInformationToolbar;
