...
const GovernmentTeacherInformationViewToolbar = (props) => {
  ...
  const hasPermissionToEdit = useSelector(
    governmentTeacherInformationSelectors.selectPermissionToEdit,
  );
  ...
  return (
    <Toolbar>
      {hasPermissionToEdit && (
        <Link to={`/government-teacher-information/${id}/edit`}>
...
export default GovernmentTeacherInformationViewToolbar;
