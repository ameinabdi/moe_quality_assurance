...
import selectors from 'src/modules/report/teacherReport/teacherReportSelectors';
import Spinner from '../shared/Spinner';
import { useSelector } from 'react-redux';
 import { Column,Pie } from '@ant-design/plots';
 import ContentWrapperTransaparent from 'src/view/layout/styles/ContentWrapperTransaparent';
 import Breadcrumb from 'src/view/shared/Breadcrumb';
 import actions from 'src/modules/report/teacherReport/teacherReportActions';
     ...
     <Row>
      <Col span={18}>
        <Card title="Teachers By Education Level ">
          <Column 
          {...{
            data:rows?.teacherByEdacutionLevel || [],
