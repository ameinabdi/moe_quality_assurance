...
const previewRenders = {
  indicator11: {
    ...
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator11',),
  },
  indicator12: {
    label: i18n('entities.dimensionSsv1.fields.indicator12'),
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator12',),
  },
  indicator13: {
    label: i18n('entities.dimensionSsv1.fields.indicator13'),
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator13',),
  },
  indicator14: {
    label: i18n('entities.dimensionSsv1.fields.indicator14'),
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator14',),
  },
  indicator15: {
    label: i18n('entities.dimensionSsv1.fields.indicator15'),
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator15',),
  },
  indicator16: {
    label: i18n('entities.dimensionSsv1.fields.indicator16'),
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator16',),
  },
  indicator17: {
    label: i18n('entities.dimensionSsv1.fields.indicator17'),
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator17',),
  },
  indicator18: {
    label: i18n('entities.dimensionSsv1.fields.indicator18'),
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator18',),
  },
  indicator19: {
    label: i18n('entities.dimensionSsv1.fields.indicator19'),
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator19',),
  },
  indicator110: {
    label: i18n('entities.dimensionSsv1.fields.indicator110'),
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator110',),
  },
  indicator111: {
    label: i18n('entities.dimensionSsv1.fields.indicator111'),
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator111',),
  },
  indicator112: {
    label: i18n('entities.dimensionSsv1.fields.indicator112'),
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator112',),
  },
  indicator113: {
    label: i18n('entities.dimensionSsv1.fields.indicator113'),
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator113',),
  },
  indicator114: {
    label: i18n('entities.dimensionSsv1.fields.indicator114'),
    render: filterRenders.enumerator('entities.dimensionSsv1.enumerators.indicator114',),
  },
  school: {
...
const DimensionSsv1ListFilter = (props) => {
              ...
              <Row gutter={24}>
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator11"
                    label={i18n('entities.dimensionSsv1.fields.indicator11')}
                    options={dimensionSsv1Enumerators.indicator11.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator12"
                    label={i18n('entities.dimensionSsv1.fields.indicator12')}
                    options={dimensionSsv1Enumerators.indicator12.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator13"
                    label={i18n('entities.dimensionSsv1.fields.indicator13')}
                    options={dimensionSsv1Enumerators.indicator13.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator14"
                    label={i18n('entities.dimensionSsv1.fields.indicator14')}
                    options={dimensionSsv1Enumerators.indicator14.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator15"
                    label={i18n('entities.dimensionSsv1.fields.indicator15')}
                    options={dimensionSsv1Enumerators.indicator15.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator16"
                    label={i18n('entities.dimensionSsv1.fields.indicator16')}
                    options={dimensionSsv1Enumerators.indicator16.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator17"
                    label={i18n('entities.dimensionSsv1.fields.indicator17')}
                    options={dimensionSsv1Enumerators.indicator17.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator18"
                    label={i18n('entities.dimensionSsv1.fields.indicator18')}
                    options={dimensionSsv1Enumerators.indicator18.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator19"
                    label={i18n('entities.dimensionSsv1.fields.indicator19')}
                    options={dimensionSsv1Enumerators.indicator19.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator110"
                    label={i18n('entities.dimensionSsv1.fields.indicator110')}
                    options={dimensionSsv1Enumerators.indicator110.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator111"
                    label={i18n('entities.dimensionSsv1.fields.indicator111')}
                    options={dimensionSsv1Enumerators.indicator111.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator112"
                    label={i18n('entities.dimensionSsv1.fields.indicator112')}
                    options={dimensionSsv1Enumerators.indicator112.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator113"
                    label={i18n('entities.dimensionSsv1.fields.indicator113')}
                    options={dimensionSsv1Enumerators.indicator113.map(
                      (value) => ({
                        value,
                        label: i18n(
                ...
                <Col xs={24} md={24} lg={12}>
                  <SelectFormItem
                    name="indicator114"
                    label={i18n('entities.dimensionSsv1.fields.indicator114')}
                    options={dimensionSsv1Enumerators.indicator114.map(
                      (value) => ({
                        value,
                        label: i18n(
...
export default DimensionSsv1ListFilter;