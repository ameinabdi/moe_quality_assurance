...
const TeacherGPEToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    teacherGPESelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    teacherGPESelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToImport && (
        <Link to="/teacher-g-p-e/importer">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=teacherGPE">
...
export default TeacherGPEToolbar;
