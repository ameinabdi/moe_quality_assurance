  ...
  return (
    <ViewWrapper>
      {Boolean(record.indicator51) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator51.${record.indicator51}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator52) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator52.${record.indicator52}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator53) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator53.${record.indicator53}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator54) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator54.${record.indicator54}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator55) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator55.${record.indicator55}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator56) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator56.${record.indicator56}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator57) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator57.${record.indicator57}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator58) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator58.${record.indicator58}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator59) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator59.${record.indicator59}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator510) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator510.${record.indicator510}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator511) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator511.${record.indicator511}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator512) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator512.${record.indicator512}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator513) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator513.${record.indicator513}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator514) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator514.${record.indicator514}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator515) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator515.${record.indicator515}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator516) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator516.${record.indicator516}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator517) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator517.${record.indicator517}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator518) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator518.${record.indicator518}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator519) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator519.${record.indicator519}`,
          )}
        </Form.Item>
      )}
      ...
      {Boolean(record.indicator520) && (
        ...
        >
          {i18n(
            `entities.dimensionSsv3.enumerators.indicator520.${record.indicator520}`,
          )}
        </Form.Item>
      )}
...
export default DimensionSsv3View;
