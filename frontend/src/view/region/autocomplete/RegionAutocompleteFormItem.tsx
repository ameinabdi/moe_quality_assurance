...
import RegionFormModal from 'src/view/region/form/RegionFormModal';
...
const RegionAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return RegionService.listAutocomplete(value, limit);
  };
...
export default RegionAutocompleteFormItem;
