...
const RegionToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    regionSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    regionSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=region">
