...
const previewRenders = {
  indicator11: {
    ...
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator11',),
  },
  indicator12: {
    label: i18n('entities.dimension1.fields.indicator12'),
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator12',),
  },
  indicator13: {
    label: i18n('entities.dimension1.fields.indicator13'),
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator13',),
  },
  indicator14: {
    label: i18n('entities.dimension1.fields.indicator14'),
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator14',),
  },
  indicator15: {
    label: i18n('entities.dimension1.fields.indicator15'),
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator15',),
  },
  indicator16: {
    label: i18n('entities.dimension1.fields.indicator16'),
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator16',),
  },
  indicator17: {
    label: i18n('entities.dimension1.fields.indicator17'),
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator17',),
  },
  indicator18: {
    label: i18n('entities.dimension1.fields.indicator18'),
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator18',),
  },
  indicator19: {
    label: i18n('entities.dimension1.fields.indicator19'),
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator19',),
  },
  indicator110: {
    label: i18n('entities.dimension1.fields.indicator110'),
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator110',),
  },
  indicator111: {
    label: i18n('entities.dimension1.fields.indicator111'),
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator111',),
  },
  indicator112: {
    label: i18n('entities.dimension1.fields.indicator112'),
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator112',),
  },
  indicator113: {
    label: i18n('entities.dimension1.fields.indicator113'),
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator113',),
  },
  indicator114: {
    label: i18n('entities.dimension1.fields.indicator114'),
    render: filterRenders.enumerator('entities.dimension1.enumerators.indicator114',),
  },
  school: {
...
const Dimension1ListFilter = (props) => {
...
export default Dimension1ListFilter;