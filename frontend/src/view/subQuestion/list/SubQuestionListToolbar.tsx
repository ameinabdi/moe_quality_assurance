...
const SubQuestionToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    subQuestionSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    subQuestionSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=subQuestion">
...
export default SubQuestionToolbar;
