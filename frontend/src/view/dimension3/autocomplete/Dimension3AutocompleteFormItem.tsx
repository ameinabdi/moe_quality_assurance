...
import Dimension3FormModal from 'src/view/dimension3/form/Dimension3FormModal';
...
const Dimension3AutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return Dimension3Service.listAutocomplete(value, limit);
  };
...
export default Dimension3AutocompleteFormItem;
