...
import { useAppDispatch } from 'src/modules/hook';import dimension3Selectors from 'src/modules/dimension3/dimension3Selectors';
...
const Dimension3Toolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    dimension3Selectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    dimension3Selectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=dimension3">
...
export default Dimension3Toolbar;
