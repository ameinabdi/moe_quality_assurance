...
const DimensionGPE3Toolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    dimensionGPE3Selectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    dimensionGPE3Selectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToImport && (
        <Link to="/dimension-g-p-e3/importer">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=dimensionGPE3">
...
export default DimensionGPE3Toolbar;
