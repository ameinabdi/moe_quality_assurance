...
const selectAuditLogToRead = createSelector(
  ...
  (currentTenant, currentUser) =>
    new PermissionChecker(currentTenant, currentUser).match(
      Permissions.values.governmentTeacherInformationRead,
    ),
);
...
const selectPermissionToImport = createSelector(
  ...
  (currentTenant, currentUser) =>
    new PermissionChecker(currentTenant, currentUser).match(
      Permissions.values.governmentTeacherInformationImport,
    ),
);
...
const governmentTeacherInformationSelectors = {
...
export default governmentTeacherInformationSelectors;
