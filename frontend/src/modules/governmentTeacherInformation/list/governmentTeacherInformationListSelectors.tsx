...
const selectRaw = (state) => state.governmentTeacherInformation.list;
...
const governmentTeacherInformationListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
...
export default governmentTeacherInformationListSelectors;
