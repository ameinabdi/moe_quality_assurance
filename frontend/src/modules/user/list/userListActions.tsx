...
const userListActions = {
  ...
  ROLE_FETCH_STARTED: `${prefix}_ROLE_FETCH_STARTED`,
  ROLE_FETCH_SUCCESS: `${prefix}_ROLE_FETCH_SUCCESS`,
  ROLE_FETCH_ERROR: `${prefix}_ROLE_FETCH_ERROR`,
  ...
  doFetchRoles: (filter?, rawFilter?, keepPagination = false) => async (
    dispatch,
    getState,
  ) => {
    try {
      dispatch({
        type: userListActions.ROLE_FETCH_STARTED,
        payload: { filter, rawFilter, keepPagination },
      });
      ...
      dispatch({
        type: userListActions.ROLE_FETCH_SUCCESS,
        payload: {
          rows: response.rows,
          count: response.count,
        },
      ...
      dispatch({
        type: userListActions.ROLE_FETCH_ERROR,
      });
    }
  },
