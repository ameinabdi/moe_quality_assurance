...
const selectPermissionCurrentUser = createSelector(
  [selectRaw],
...
const selectLoadingVerifyTwoFA = createSelector(
  [selectRaw],
  (auth) => Boolean(auth.loadingVerifyTwoFA),
);
