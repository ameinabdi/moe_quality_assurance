...
import selectors from 'src/modules/report/accountStatement/accountStatementSelectors';
import { i18n } from 'src/i18n';
import exporterFields from 'src/modules/dashboard/view/dashboardViewExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'ACCOUNT_STATEMENT_LIST';
...
const reportActions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await ReportService.accountStatement(
        filter,
