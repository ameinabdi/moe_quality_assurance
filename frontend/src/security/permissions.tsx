  ...
  static get values() {
    return {
      ...
      schoolSupervisionGPEImport: {
        ...
        allowedRoles: [roles.admin,  roles.school, roles.federal,roles.district],
        allowedPlans: [plans.free, plans.growth, plans.enterprise],
      },
      schoolSupervisionGPECreate: {
        id: 'schoolSupervisionGPECreate',
        allowedRoles: [roles.admin, roles.federal, roles.state, roles.school,roles.district],
        allowedPlans: [plans.free, plans.growth, plans.enterprise],
        allowedStorage: [
      ...
      schoolSupervisionGPEDestroy: {
        ...
        allowedRoles: [roles.admin, roles.federal, roles.state, roles.school],
        allowedPlans: [plans.free, plans.growth, plans.enterprise],
        allowedStorage: [
          storage.schoolSupervisionGPESignatureofprincipal,
          storage.schoolSupervisionGPESchoolStamp,
      ...
      sSASurveyCreate: {
        id: 'sSASurveyCreate',
        allowedRoles: [roles.admin, roles.school, roles.federal, roles.SchoolSSA],
        allowedPlans: [plans.free, plans.growth, plans.enterprise],
        allowedStorage: [
      ...
      dimension1Read: {
        id: 'dimension1Read',
        allowedRoles: [roles.admin, roles.federal, roles.state, roles.district, roles.school, roles.SchoolSSA],
        allowedPlans: [plans.free, plans.growth, plans.enterprise],
      },
      ...
      schoolSupervisionImport: {
        ...
        allowedRoles: [roles.admin, roles.federal, roles.state,  roles.school,  roles.districtRCF, roles.districtTeacherRCF],
        allowedPlans: [plans.free, plans.growth, plans.enterprise],
      },
      ...
      schoolSupervisionDestroy: {
        ...
        allowedRoles: [roles.admin, roles.federal, roles.state, roles.districtRCF, roles.districtTeacherRCF],
        allowedPlans: [plans.free, plans.growth, plans.enterprise],
        allowedStorage: [
          storage.schoolSupervisionSignatureofprincipal,
          storage.schoolSupervisionSchoolStamp,
